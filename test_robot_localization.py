...
# we determined this distance function via nonlinear regression in pixels_to_distance.py
...
for location in all_locations:
	...
	print estimated_point, location, error, elapsed
